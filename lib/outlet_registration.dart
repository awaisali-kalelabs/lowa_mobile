    ...
    return Scaffold(
      ...
      onPressed: () async {
        ...
        if (_formKey.currentState?.validate() ?? false) {
          // Show dialog with two options: "Save Outlet" and "Place Order"
          showDialog(
            context: context,
            builder: (BuildContext context) {
              return AlertDialog(
                title: Text("Choose an option"),
                content: Text("Would you like to save the outlet or place an order?"),
                actions: <Widget>[
                  TextButton(
                      ...
                      child: (Column(
                        children: [
                            ...
                            child: Row(
                              children: <Widget>[
                                ...
                                TextButton.icon(
                                  ...
                                  label: Text("Camera",
                                      style:
                                          TextStyle(color: Color(0xFFC9002B))),
                                ),
                              ],
                            ),
                          ),
                          ...
                          Container(
                              ...
                              child: TypeAheadFormField(
                                textFieldConfiguration: TextFieldConfiguration(
                                  ...
                                  controller:
                                      this._OutletChanneltypeAheadController,
                                ),
                                suggestionsCallback: (pattern) async {
                                  return await repo
                                      .getChannel("%" + pattern + "%");
                          ...
                          MaterialButton(
                              ...
                              onPressed: () async {
                                print("globals.currentPosition:" +
                                    globals.currentPosition.toString());
                                if (globals.currentPosition == null) {
                                  ...
                                  globals
                                    ...
                                    if (isLocationTimedOut) {
                                      ...
                                      LatController.text = globals
                                          .currentPosition.latitude
                                          .toString();
                                      AccuracyController.text = globals
                                          .currentPosition.accuracy
                                          .toString();
                                      LongController.text = globals
