...
//				                                                                                                                                                                                                                                                                                                                   	/co.purchaser_name,co.purchaser_mobile_no,co.cache_contact_nic,
  ...
  PreSellOutlets( {this.outlet_id, this.outlet_name, this.day_number, this.owner,
      this.address, this.telephone, this.nfc_tag_id, this.visit_type, this.lat, this.lng, this.area_label,
    this.sub_area_label, this.is_alternate_visible, this.pic_channel_id,this.channel_label,this.order_created_on_date,this.common_outlets_vpo_classifications,this.Visit,this.purchaser_name,this.purchaser_mobile_no,this.cache_contact_nic
      });
  ...
  factory PreSellOutlets.fromJson(Map<String, dynamic> json){
    return PreSellOutlets(outlet_id:int.parse(json['OutletID']),outlet_name:json['OutletName'],address:json['Address'],
        ...
        ,area_label:json['AreaLabel'],sub_area_label:json['SubAreaLabel'], is_alternate_visible: json['is_alternate_visible'] , pic_channel_id: json['SUBChannelID'] , channel_label: json['SUBChannelLabel'], order_created_on_date: json['order_created_on_date'],common_outlets_vpo_classifications:json['common_outlets_vpo_classifications'],Visit:json['Visit'],purchaser_name:json['purchaser_name'],purchaser_mobile_no:json['purchaser_mobile_no'],cache_contact_nic:json['cache_contact_nic']);
  }
